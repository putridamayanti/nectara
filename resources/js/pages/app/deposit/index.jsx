...
export default function Deposit({ deposit, setting }) {
    const { url } = usePage();
    ...
    const submitDelete = () => {
        return Inertia.delete(`/app/deposit/${selectedItems.join(',')}`)
    };
                ...
                <CardContent>
                    ...
                    <TableContainer>
                        <Table sx={{ whiteSpace: 'nowrap' }}>
                            ...
                            <TableBody>
                                {deposit.data.length > 0 ? deposit?.data?.map((row, i) => (
                                    <TableRow key={i}>
                                        ...
                                        <TableCell align="right">
                                            <Tooltip title="Edit">
                                                <Link href={`/app/deposit/${row.id}/edit`}>
                                                    <IconButton>
                    ...
                    <Stack direction="row" paddingTop={3} justifyContent="end">
                        <Pagination
                            color="secondary"
                            count={deposit?.last_page ?? 1}
                            page={deposit.current_page}
