...
export default function Employee({ employee }) {
    ...
    const submitDelete = () => {
        return Inertia.delete(`/app/employee/${selectedItems.join(',')}`)
    };
                ...
                <CardContent>
                    ...
                    <TableContainer>
                        <Table sx={{ whiteSpace: 'nowrap' }}>
                            ...
                            <TableBody>
                                {employee.data.length > 0 ? employee?.data?.map((row, i) => (
                                    <TableRow key={i}>
                                        ...
                                        <TableCell align="right">
                                            <Tooltip title="Edit">
                                                <Link href={`/app/employee/${row.id}/edit`}>
                                                    <IconButton>
                    ...
                    <Stack direction="row" paddingTop={3} justifyContent="end">
                        <Pagination
                            color="secondary"
                            count={employee?.last_page ?? 1}
                            page={employee.current_page}
